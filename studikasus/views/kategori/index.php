...
error_reporting(E_ERROR | E_PARSE);
  ...
  ?>
<h3>Data Kategori</h3>
<a href="tambahKategori"class="btn btn-primary mb-3 mt-2">Tambah Mahasiswa</a>
...
foreach($kategori as $x){
    ...
    <tr>
        ...
        <td>
            ...
            <a href="hapusKategori?id_kategori=<?php echo $x['id_kategori'];?>" onclick = "return confirm 
